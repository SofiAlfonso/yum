#Autor: Jhon Freddy Alzate y Ana Sofía Alfonso
...
from .views import (
    ...
    AdminUserDeleteView, AdminRecipeListView, AdminRecipeDetailView, 
    AdminRecipeUpdateView, AdminRecipeDeleteView, AdminIngredientTypeListView, 
    AdminIngredientTypeDetailView, AdminIngredientTypeUpdateView, 
    AdminIngredientTypeDeleteView, AdminInstructionCreateView, 
    AdminInstructionUpdateView, AdminInstructionDeleteView, 
    AdminReviewDeleteView, AdminRecipeReportView
)
...
urlpatterns = [
    ...
    # 🆕 REPORTES - Inversión de Dependencias
    path("recipes/report/", AdminRecipeReportView.as_view(), name="admin_recipe_report"),
